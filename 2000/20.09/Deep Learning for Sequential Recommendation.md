...
- 当然还有一个新发现，这个叫 privileged information 的东西还是挺吸引我的，虽然不知道是不是和我想得一样：看来这个关于特权信息的论文，是说利用训练集里面出现的信息来训练不出现在测试集里面，论文里面提到的是考虑目标项目之后的项目也可能包含有价值的信息，将这些项目称之为特权信息，可能跟广泛的定义吧
